...
def run_sim(porb_model="sana12", q_power_law=0, processes=32, extra_time=200 * u.Myr, file=None):
...
def main():
    ...
    parser.add_argument('--porb_model', default="sana12", type=str,
                        help='Binary orbital period model')
    parser.add_argument('--q_power_law', default=0, type=int,
